...
import { ExchangeRateApi } from '../src/providers/exchage/ExchangeRateApi'
import { FrankfurterApi } from '../src/providers/exchage/FrankfurterApi'

describe('Exchange', () => {
    describe.each([
        [FrankfurterApi.name, FrankfurterApi],
        [ExchangeRateApi.name, ExchangeRateApi],
    ])('%s Provider', (name, Provider) => {
        const skipKey = ['FrankfurterApi'].includes(name)
        ...
        describe('send', () => {
            ...
            it.skipIf(skipKey)('should throw error if API key is missing', async () => {
            ...
            it.skipIf(skipKey)('should throw error for invalid API key', async () => {
